...
struct interrupt_vector const _vectab[] = {
  ...
  {0x82, (interrupt_handler_t)USART3_TX_IRQHandler},      /* irq21 - TIM3 Update/Overflow/Trigger/Break interrupt */

  {0x82, (interrupt_handler_t)USART3_RX_IRQHandler},			/* irq22 - TIM3 Capture/Compare interrupt */
