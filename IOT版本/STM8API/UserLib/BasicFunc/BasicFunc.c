...
// 返回参数  : None
//※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※
char U16ToString(unsigned int Val,unsigned char *Str)
{
  char i=0,j=0;
  unsigned char TempTran[10];
  do
  {
    Str[i++] = Val%10 + '0';
  }while(Val/=10);
